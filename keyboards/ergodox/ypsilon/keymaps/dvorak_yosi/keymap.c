 ...
 *
 *    ,--------------------------------------------------.           ,--------------------------------------------------.
 * L1 |   =    |   1  |   2  |   3  |   4  |   5  | NumLk|           | Del  |   6  |   7  |   8  |   9  |   0  |   \    | L1
 *    |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------| 
...
[BASE] = KEYMAP(  // layer 0 : default
	...
	TG(SYMB),  KC_EQL,   KC_1,             KC_2,    KC_3,   KC_4,   KC_5,   KC_NLCK,
        ...
        KC_NO,     KC_ESC,   KC_A,             KC_O,    KC_E,   KC_U,   KC_I,
                   KC_LSFT,  CTL_T(KC_SCLN),   KC_Q,    KC_J,   KC_K,   KC_X,   MO(MDIA),
...
[SYMB] = KEYMAP(
       // left hand
       KC_TRNS, KC_TRNS, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_TRNS,
       KC_TRNS, KC_TRNS, KC_EXLM,KC_AT,  KC_LCBR,KC_RCBR,KC_PIPE,KC_TRNS,
       KC_TRNS, KC_TRNS, KC_HASH,KC_DLR, KC_LPRN,KC_RPRN,KC_GRV,
       ...
       // right hand
       KC_TRNS, KC_F6,   KC_F7,  KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_TRNS,
       KC_TRNS, KC_UP,   KC_7,   KC_8,    KC_9,    KC_ASTR, KC_F12,  KC_TRNS,
                KC_DOWN, KC_4,   KC_5,    KC_6,    KC_PLUS, KC_TRNS, KC_TRNS,
...
KEYMAP( 
       ...
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MS_U, KC_TRNS, KC_MS_WH_UP, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_R, KC_MS_WH_DOWN,
